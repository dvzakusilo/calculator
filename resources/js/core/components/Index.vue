...
<script>
// @todo Временно добавлены напрямую, необходимо перенести во VUE
...
// Передаем в main.js через глобальные переменные
...
*/
    ...
    */
    ...
    --------------------------------------------------------------*/
    .cta {
        background: linear-gradient(rgba(40, 58, 90, 0.9), rgba(40, 58, 90, 0.9)), url("../../../../resources/img/cta-bg.jpg") fixed center center;
